...
public class UserServiceImpl implements UserService{
    ...
    public String register(User user) {
        ...
        Optional<User> existUserWithMail = userRepository.findByEmail(user.getEmail());
        if(existUser.isPresent()){
            return "\"message\" : \"Username already exists.\"";
        } else if (existUserWithMail.isPresent()) {
            return "\"message\" : \"User with Same Email already exists.\"";
        } else{
